...
module.exports = class RedshiftJunction extends StorageJunction {
  ...
  async getEncoding() {
    ...
    try {
      ...
      this._this._logger.debug(JSON.stringify(columns, replacer, "  "));
      ...
      this._this._logger.error(err.odbcErrors ? err.odbcErrors[0].message : err.message);
      throw err;
    }
  }
  ...
  async putEncoding(encoding) {
    ...
    try {
      ...
      this._this._logger.debug(JSON.stringify(tables, replacer, "  "));
